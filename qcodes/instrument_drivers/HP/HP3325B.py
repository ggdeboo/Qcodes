...
def boolean_parser(command: str, instrument_response: str) -> bool:
...
def freq_parser(command: str, instrument_response: str) -> float:
...
class HP3325B(VisaInstrument):
    """
    This is the instrument driver for Hewlett Packard 3325B synthesizer.
    """
    def __init__(self, name, address, reset=False,  **kwargs):
        super().__init__(name, address,  terminator='\n', **kwargs)
        self.visa_handle.baud_rate = 4800 # switch 3 and 4 on the rear down
